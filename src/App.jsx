...
function App() {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 font-sans text-gray-800 flex flex-col">
      ...
      {/* Main Content Area: Use a wrapper to create the purple top section and white bottom section */}
      <main className="flex-grow w-full">
        {/* Top Purple Background Section */}
        <div className="bg-indigo-700 pt-4 sm:pt-8 pb-[100px] sm:pb-[140px]"> {/* Increased padding bottom to cover 50% of feature blocks */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 relative z-20" style={{ marginTop: '-100px' }}> {/* Negative margin pulls it up over the purple section */}
        ...
        <div className="bg-white pb-16 pt-4"> {/* Padding top is small since the feature blocks have been pulled up */}
          <div className="max-w-7xl mx-auto px-4 sm:px-8">
